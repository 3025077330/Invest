        ...
        baseViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (iRecyclerViewItemClickListener != null) {
                    Log.i("WYF", baseViewHolder.getLayoutPosition() + "------getLayoutPosition()");
                    Log.i("WYF", baseViewHolder.getAdapterPosition() + "------getAdapterPosition()");
                    Log.i("WYF", baseViewHolder.getAdapterPosition() + "------getAdapterPosition()");
                    Log.i("WYF", position + "------postion");
                    iRecyclerViewItemClickListener.onItemClick(baseViewHolder.getLayoutPosition() );//设置Item的点击事件
                }
            }
        });
